...
class DefaultLayouts {
    ...
    static let SwitchConfig: LayoutConfig = .init(name: "Switch", buttons: [
        ...
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.5, y: 0.2), offset: CGPoint(x: DEFAULT_BUTTON_SIZE * 0.6, y: DEFAULT_BUTTON_SIZE * 0.6)), scale: 0.6, inputId: 10, input: "Screenshot", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "square")),
    ...
    static let PlayStationConfig: LayoutConfig = .init(name: "PlayStation", buttons: [
        // Diamond of buttons
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.8, y: 0.6), offset: CGPoint(x: 0, y: -DEFAULT_BUTTON_SIZE)), scale: 0.75, inputId: 0, input: "Triangle", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "triangle")),
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.8, y: 0.6), offset: CGPoint(x: -DEFAULT_BUTTON_SIZE, y: 0)), scale: 0.75, inputId: 1, input: "Square", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "square")),
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.8, y: 0.6), offset: CGPoint(x: DEFAULT_BUTTON_SIZE, y: 0)), scale: 0.75, inputId: 2, input: "Circle", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "circle")),
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.8, y: 0.6), offset: CGPoint(x: 0, y: DEFAULT_BUTTON_SIZE)), scale: 0.75, inputId: 3, input: "X", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "xmark")),
        ...
        // Menu
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.5, y: 0.2), offset: CGPoint(x: -DEFAULT_BUTTON_SIZE * 0.6, y: 0)), scale: 0.6, inputId: 7, input: "Menu", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "line.3.horizontal")),
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.5, y: 0.2), offset: CGPoint(x: DEFAULT_BUTTON_SIZE * 0.6, y: 0)), scale: 0.6, inputId: 8, input: "Window", style: .init(shape: .Circle, iconType: .SFSymbol, icon: "light.max")),
    ...
    static let WiiConfig: LayoutConfig = .init(name: "Wii", buttons: [
        // Diamond of buttons
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.5, y: 0.8), offset: CGPoint(x: 0, y: -DEFAULT_BUTTON_SIZE * 0.75)), scale: 0.75, inputId: 0, input: "1"),
        RegularButtonConfig(position: .init(scaledPos: CGPoint(x: 0.5, y: 0.8), offset: CGPoint(x: 0, y: DEFAULT_BUTTON_SIZE * 0.75)), scale: 0.75, inputId: 1, input: "2"),
